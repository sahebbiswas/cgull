...
_BUILTIN_EFFECTS = {
    ...
    for model in (
        ...
        _effect("bzero", output_parameters=frozenset({0}), size_relationships=((0, 1),)),
        _effect("explicit_bzero", output_parameters=frozenset({0}), size_relationships=((0, 1),)),
        _effect("sprintf", output_parameters=frozenset({0})),
        _effect("snprintf", output_parameters=frozenset({0}), size_relationships=((0, 1),)),
        _effect("vsprintf", output_parameters=frozenset({0})),
        _effect("vsnprintf", output_parameters=frozenset({0}), size_relationships=((0, 1),)),
