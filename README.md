...
| **CGULL-030** | Command Injection Vulnerability | **High** | Control Flow | CWE-78 | Hybrid | Flags use of `system()`, `popen()`, or `execlp()`/`execvp()` (PATH-searching variants) with non-literal string arguments. |
