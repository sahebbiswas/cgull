...
### Fixed
- CGULL-006: treat allocation-size accumulations that feed malloc/realloc as overflow-sensitive even after partial INT_MAX-style gates (cJSON ensure()-style `needed += offset + 1`), and stop treating bare INT_MAX comparisons as proving add/mul safety in allocation arguments (#560).
